...
angular.module('controller.settings', []).controller('SettingsController', function ($scope, AuthenticationService, $location, $rootScope, $ionicModal, $ionicPopup, ApiService, CachingService) {
	$scope.resources = ["well", "dam", "rain_gauge"];
  ...
  */
	...
	$scope.closeModal = function (form) {
		...
		if (form == null || form.postcode == null || form.owner == null || form.postcode == null || form.id == null || form.max_wt_depth == null || form.type == null || form.lat == null || form.lng == null) {
