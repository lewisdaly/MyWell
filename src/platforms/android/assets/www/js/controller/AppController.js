...
angular.module('starter.controllers', ['ionic']).controller('AppController', function ($scope, $ionicModal, AuthenticationService, $state, $rootScope, LoginService, ApiService) {
  ...
  $scope.performLogin = function (form) {
    ...
    ApiService.login('marvi', form.password).then(function (response) {
